...
NAME = libworld_gen.so

TEST_NAME = test_container
TEST_REPORT_NAME = $(REPORTDIR)/report.html

SRCS += srcs/algo/Reducer.cpp
SRCS += srcs/algo/MinMax.cpp
SRCS += srcs/algo/Normalizer.cpp
SRCS += srcs/noise/perlin/Perlin2D.cpp
SRCS += srcs/opencl/AbstractRuntime.cpp
SRCS += srcs/opencl/DefaultRuntime.cpp
SRCS += srcs/opencl/errors.cpp
SRCS += srcs/opencl/exceptions.cpp
